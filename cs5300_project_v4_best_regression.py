# -*- coding: utf-8 -*-
"""cs5300_project_v4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KR2ksBrQQ3yl6gwmQkAlID-X-HMBsXnF

# CS5300 Project Version 4: Added Genres
...
import numpy as np
dataset = np.loadtxt('movie_metadata_usa_allgenres_modern.csv', skiprows = 1,  delimiter=',')
...
history = model.fit(trainset_input, trainset_output, epochs= 64, verbose = 0, batch_size=16, validation_data = (validset_input, validset_output))
