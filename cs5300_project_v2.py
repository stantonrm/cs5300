# -*- coding: utf-8 -*-
"""cs5300_project_v2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WcG7U-VITW-Dork8fyXbk6b4LOnA-gIk

# CS5300 Project Version 2: Split the Ratings
No real improvement
"""
...
import numpy as np
dataset = np.loadtxt('movie_metadata_super_clean_usa_v2.csv', skiprows = 1,  delimiter=',')
...
plt.xlabel('2nd feature - G Rating')
plt.ylabel('gross revenue')
plt.show()

plt.figure(figsize=(4,4))
plt.plot(trainset[:, 2], trainset[:, dataset_features], '.')
plt.xlabel('3nd feature - PG Rating')
plt.ylabel('gross revenue')
plt.show()
