# -*- coding: utf-8 -*-
"""cs5300_project_output_as_input.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12L65kjG3VVPYW8dBMnrX55QKRK0vvNTg

# CS5300 Project Version 3: Added Genres 
[USED OUTPUT AS INPUT TO TEST MODEL]
...
import numpy as np
dataset = np.loadtxt('movie_metadata_super_clean_usa_v3 (1).csv', skiprows = 1,  delimiter=',')
...
trainset_input = trainset[:, 0:dataset_features + 1]
trainset_output = trainset[:, dataset_features:]
validset_input = validset[:, 0:dataset_features + 1]
...
model = Sequential()
model.add(Dense(1, input_dim = dataset_features + 1, activation='linear'))
print(model.summary())
model.compile(loss='mse', optimizer='sgd', metrics=['mae'])
# Verbose = 0 shows no updates, can be changed to 1 or 2
history = model.fit(trainset_input, trainset_output, epochs= 128, verbose = 0, batch_size=32, validation_data = (validset_input, validset_output))
